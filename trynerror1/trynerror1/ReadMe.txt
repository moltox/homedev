========================================================================
    KONSOLENANWENDUNG: trynerror1-Projektübersicht
========================================================================

Diese trynerror1-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre trynerror1-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen trynerror1.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.

========================================================================
    KONSOLENANWENDUNG: flaechenrechner_pro-Projektübersicht
========================================================================

Diese flaechenrechner_pro-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre flaechenrechner_pro-Anwendung besteht.


flaechenrechner_pro.vcxproj
...
flaechenrechner_pro.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen flaechenrechner_pro.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
